...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-[50%] top-[50%] z-50 grid w-full max-w-[90vw] md:max-w-[800px] translate-x-[-50%] translate-y-[-50%] gap-4 border border-gray-200 dark:border-[#333333] bg-white dark:bg-[#1F2023] p-0 shadow-xl duration-300 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 rounded-2xl",
        className
      )}
      {...props}
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 z-10 rounded-full bg-gray-200/80 dark:bg-[#2E3033]/80 p-2 hover:bg-gray-200 dark:hover:bg-[#2E3033] transition-all">
    ...
    >
      ...
      <div className="w-full h-10 flex items-center justify-center gap-0.5 px-4">
        {[...Array(visualizerBars)].map((_, i) => (
          <div
            key={i}
            className="w-0.5 rounded-full bg-gray-900/50 dark:bg-white/50 animate-pulse"
            style={{
      ...
      <TooltipProvider>
        ...
        >
          <div
            ref={ref}
            className={cn(
              "rounded-3xl border border-gray-200 dark:border-[#444444] bg-white dark:bg-[#1F2023] p-2 shadow-[0_8px_30px_rgba(0,0,0,0.1)] dark:shadow-[0_8px_30px_rgba(0,0,0,0.24)] transition-all duration-300",
  ...
  return (
    <>
      <PromptInput
        ...
        className={cn(
          "w-full bg-white dark:bg-[#1F2023] border-gray-200 dark:border-[#444444] shadow-[0_8px_30px_rgba(0,0,0,0.1)] dark:shadow-[0_8px_30px_rgba(0,0,0,0.24)] transition-all duration-300 ease-in-out",
          ...
          >
            <PromptInputAction tooltip="Upload image">
              <button
                ...
                className="flex h-8 w-8 text-gray-400 dark:text-[#9CA3AF] cursor-pointer items-center justify-center rounded-full transition-colors hover:bg-gray-200 dark:hover:bg-gray-600/30 hover:text-gray-700 dark:hover:text-[#D1D5DB]"
              ...
              <button
                ...
                className={cn(
                  ...
                  showSearch
                    ...
                    : "bg-transparent border-transparent text-gray-400 dark:text-[#9CA3AF] hover:text-gray-700 dark:hover:text-[#D1D5DB]"
                )}
              >
